...
def TransferTestingFoolX(net, net2, eps, csvname):
    ...
    for filename in glob.glob('D:/Imagenet/ILSVRC2012/ILSVRC/Data/CLS-LOC/val/*.JPEG'):  # assuming jpg
        ...
        if (int(label_pert2) == int(correct)):
            ...
            Net2FoolXAccuracy = Net2FoolXAccuracy + 1
    ...
    with open(foolxcsv, 'a', newline='') as csvfile:
        ...
        csvwriter.writerows(["Original Perturbed Accuracy: " + str(Net1FoolXAccuracy / 5000)])
        csvwriter.writerows(["Transfered Accuracy: " + str(Net2Accuracy / 5000)])
        csvwriter.writerows(["Transferred Perturbed Accuracy: " + str(Net2FoolXAccuracy / 5000)])
...
def CIFARFoolXTesting(original_net, transfer_net, eps, csvname):
    ...
    with open(foolxcsv, 'a', newline='') as csvfile:
        ...
        csvwriter.writerows(["Original Perturbed Accuracy: " + str(Net1FoolXAccuracy / 5000)])
        csvwriter.writerows(["Transfered Accuracy: " + str(Net2Accuracy / 5000)])
        csvwriter.writerows(["Transfered Perturbed Accuracy: " + str(Net2FoolXAccuracy / 5000)])
        csvwriter.writerows(['Original Network: ' + 'resnet34'])
        csvwriter.writerows(['Transfered Network: ' + 'resnet101'])
...
#TransferTestingFoolX(orig_resnet34, eval_resnet101, 0.2, 'transfer_foolx_resnet34_to_resnet101_0.2.csv')
#TransferTestingFoolX(orig_resnet34, eval_googlenet, 0.2, 'transfer_foolx_resnet34_to_googlenet_0.2.csv')
#TransferTestingFoolX(orig_resnet34, eval_alexnet, 0.2, 'transfer_foolx_resnet34_to_alexnet_0.2.csv')
#TransferTestingFoolX(orig_resnet101, eval_resnet34, 0.2, 'transfer_foolx_resnet101_to_resnet34_0.2.csv')
#TransferTestingFoolX(orig_resnet101, eval_googlenet, 0.2, 'transfer_foolx_resnet101_to_googlenet_0.2.csv')
#TransferTestingFoolX(orig_alexnet, eval_googlenet, 0.2, 'transfer_foolx_alexnet_to_googlenet_0.2.csv')
#TransferTestingFoolX(orig_alexnet, eval_resnet34, 0.2, 'transfer_foolx_alexnet_to_resnet34_0.2.csv')
#TransferTestingFoolX(orig_googlenet, eval_resnet101, 0.2, 'transfer_foolx_googlenet_to_resnet101_0.2.csv')
#TransferTestingFoolX(orig_googlenet, eval_resnet34, 0.2, 'transfer_foolx_googlenet_to_resnet34_0.2.csv')
#TransferTestingFoolX(orig_googlenet, eval_alexnet, 0.2, 'transfer_foolx_googlenet_to_alexnet_0.2.csv')
...
#TransferTestingFoolX(net, net2, 0.01)
...
# CIFARFoolXTesting(orig_alexnet, eval_resnet34, 0.0005, 'transfer_foolx_CIFAR10_alexnet_to_resnet34_0.0005.csv')
# CIFARFoolXTesting(orig_alexnet, eval_resnet34, 0.05, 'transfer_foolx_CIFAR10_alexnet_to_resnet34_0.05.csv')
# CIFARFoolXTesting(orig_alexnet, eval_resnet34, 0.2, 'transfer_foolx_CIFAR10_alexnet_to_resnet34_0.2.csv')
#
# CIFARFoolXTesting(orig_alexnet, eval_googlenet, 0.0005, 'transfer_foolx_CIFAR10_alexnet_to_googlenet_0.0005.csv')
# CIFARFoolXTesting(orig_alexnet, eval_googlenet, 0.05, 'transfer_foolx_CIFAR10_alexnet_to_googlenet_0.05.csv')
# CIFARFoolXTesting(orig_alexnet, eval_googlenet, 0.2, 'transfer_foolx_CIFAR10_alexnet_to_googlenet_0.2.csv')
#
# CIFARFoolXTesting(orig_googlenet, eval_alexnet, 0.0005, 'transfer_foolx_CIFAR10_googlenet_to_alexnet_0.0005.csv')
# CIFARFoolXTesting(orig_googlenet, eval_alexnet, 0.05, 'transfer_foolx_CIFAR10_googlenet_to_alexnet_0.05.csv')
# CIFARFoolXTesting(orig_googlenet, eval_alexnet, 0.2, 'transfer_foolx_CIFAR10_googlenet_to_alexnet_0.2.csv')
#
# CIFARFoolXTesting(orig_googlenet, eval_resnet34, 0.0005, 'transfer_foolx_CIFAR10_googlenet_to_resnet34_0.0005.csv')
# CIFARFoolXTesting(orig_googlenet, eval_resnet34, 0.05, 'transfer_foolx_CIFAR10_googlenet_to_resnet34_0.05.csv')
# CIFARFoolXTesting(orig_googlenet, eval_resnet34, 0.2, 'transfer_foolx_CIFAR10_googlenet_to_resnet34_0.2.csv')
#
# CIFARFoolXTesting(orig_resnet34, eval_alexnet, 0.0005, 'transfer_foolx_CIFAR10_resnet34_to_alexnet_0.0005.csv')
# CIFARFoolXTesting(orig_resnet34, eval_alexnet, 0.05, 'transfer_foolx_CIFAR10_resnet34_to_alexnet_0.05.csv')
# CIFARFoolXTesting(orig_resnet34, eval_alexnet, 0.2, 'transfer_foolx_CIFAR10_resnet34_to_alexnet_0.2.csv')
#
# CIFARFoolXTesting(orig_resnet34, eval_googlenet, 0.0005, 'transfer_foolx_CIFAR10_resnet34_to_googlenet_0.0005.csv')
# CIFARFoolXTesting(orig_resnet34, eval_googlenet, 0.05, 'transfer_foolx_CIFAR10_resnet34_to_googlenet_0.05.csv')
# CIFARFoolXTesting(orig_resnet34, eval_googlenet, 0.2, 'transfer_foolx_CIFAR10_resnet34_to_googlenet_0.2.csv')

CIFARFoolXTesting(orig_alexnet, eval_resnet34, 0.0005, 'transfer_foolx_CIFAR10_alexnet_to_resnet34_0.0005')
CIFARFoolXTesting(orig_alexnet, eval_resnet34, 0.05, 'transfer_foolx_CIFAR10_alexnet_to_resnet34_0.05')
CIFARFoolXTesting(orig_alexnet, eval_resnet34, 0.2, 'transfer_foolx_CIFAR10_alexnet_to_resnet34_0.2')
